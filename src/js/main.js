...
document.addEventListener('DOMContentLoaded', () => {
  ...
  var imageNoOverflow = document.getElementsByClassName('thumbnail-no-overflow');
  ...
  Fancybox.bind('[data-fancybox=gallery]', {
    ...
    template: {
      closeButton: '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.3756 10L0 18.3756L1.6244 20L10 11.6244L18.3756 20L20 18.3756L11.6244 10L20 1.6244L18.3756 0L10 8.3756L1.6244 0L0 1.6244L8.3756 10Z" fill="#414141"/></svg>'
    },
  ...
  if (popup) {
    const timeout = popup.getAttribute('data-timeout');
    setTimeout(() => {
